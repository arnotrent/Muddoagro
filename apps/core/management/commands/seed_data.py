...
PRODUCTS=[
 {'name':'MUDDOSATE 480SL','category':'herbicide','img':'/static/images/product_muddosate.jpg','stock':120,'reorder':20,
  ...
  'description':'MUDDOSATE is MACL\'s flagship non-selective systemic herbicide for total control of annual and perennial weeds including Couch grass and Kikuyu grass. Absorbed through leaves and translocated throughout the plant to the roots.'},
 {'name':'MD MAIZE PLUS 40OD','category':'herbicide','img':'/static/images/product_maizeplus.jpg','stock':95,'reorder':15,
  ...
  'description':'MD MAIZE PLUS is a selective post-emergence herbicide for control of grass and broad-leaved weeds in maize.'},
 {'name':'MAX 2.4-D 720SL','category':'herbicide','img':'/static/images/product_max24d.jpg','stock':140,'reorder':25,
  ...
  'description':'MAX 2.4-D is a selective systemic herbicide for control of broad-leaved weeds in cereal crops.'},
 {'name':'MD AMETRYN 500SC','category':'herbicide','img':'/static/images/product_ametryn.jpg','stock':60,'reorder':10,
  ...
  'packing':'500ml, 1L, 5L',
  'description':'MD AMETRYN is a selective herbicide trusted by sugarcane and pineapple growers across Uganda.'},
 {'name':'WEED IT 75.7 XL','category':'herbicide','img':'/static/images/product_weedit.jpg','stock':75,'reorder':15,
  ...
  'description':'WEED IT 75.7 XL is a concentrated water-soluble granule for cost-effective, complete vegetation control.'},
 {'name':'MD ACELEMECTIN 48EC','category':'pesticide','img':'/static/images/product_acelemectin.jpg','stock':88,'reorder':15,
  ...
  'description':'MD ACELEMECTIN 48EC is a broad-spectrum insecticide for control of sucking and biting insect pests including whitefly, aphids and bollworm.'},
 {'name':'MD FOS 48EC','category':'pesticide','img':'/static/images/product_mdfos.jpg','stock':105,'reorder':20,
  ...
  'packing':'100ml, 250ml, 500ml, 1L, 5L',
  'description':'M-D FOS 48EC is a broad-spectrum organophosphate insecticide effective against stem borers, army worms and soil-dwelling larvae.'},
 {'name':'TOP FENOS 50EC','category':'pesticide','img':'/static/images/product_topfenos.jpg','stock':55,'reorder':10,
  ...
  'description':'TOP FENOS 50EC is a pyrethroid insecticide with fast knockdown and long residual control of major crop pests, including the Colorado potato beetle.'},
 {'name':'MD THION 350EC','category':'pesticide','img':'/static/images/product_thion.jpg','stock':70,'reorder':12,
  ...
  'packing':'100ml, 250ml, 500ml, 1L',
  'description':'MD THION provides reliable systemic and contact control of thrips, mites, aphids and caterpillars.'},
 {'name':'MD THOATE 40EC','category':'pesticide','img':'/static/images/product_thoate.jpg','stock':62,'reorder':10,
  ...
  'description':'MD THOATE 40EC is a systemic insecticide and acaricide with contact and stomach action for a wide range of pests.'},
 {'name':'TOP-LAXLY M 72WP','category':'fungicide','img':'/static/images/product_toplaxym.jpg','stock':115,'reorder':20,
  ...
  'description':'TOP-LAXLY M is a systemic fungicide for control of downy mildew, black spots and blight.'},
 {'name':'MD TOP LAXLYN 72WP','category':'fungicide','img':'/static/images/product_toplaxlyn.jpg','stock':90,'reorder':15,
  ...
  'description':'MD TOP LAXLYN 72WP is a systemic and contact fungicide for control of downy mildew and Alternaria blight.'},
 {'name':'TOPLAXLY 72WP','category':'fungicide','img':'/static/images/product_toplaxly.jpg','stock':80,'reorder':15,
  ...
  'packing':'100g, 250g, 500g, 1kg',
  'description':'TOPLAXLY is a protective and curative fungicide against late blight and downy mildew.'},
 {'name':'COPPER OXYCHLORIDE 850WP','category':'fungicide','img':'/static/images/product_copperoxy.jpg','stock':78,'reorder':12,
  ...
  'description':'A trusted multi-site protective fungicide and bactericide for fungal and bacterial diseases.'},
 {'name':'UREA 46%N','category':'other','img':'/static/images/product_urea.jpg','stock':200,'reorder':40,
  ...
  'description':'High-analysis nitrogen fertilizer for rapid vegetative growth, widely used by Uganda\'s farmers for maize, vegetables and cash crops.'},
 {'name':'NPK 17:17:17','category':'other','img':'/static/images/product_npk.jpg','stock':180,'reorder':30,
  ...
  'packing':'1 kg, 5 kg, 25 kg, 50 kg bags',
  'description':'Balanced compound fertilizer supplying equal nitrogen, phosphorus and potassium for strong root development.'},
 {'name':'FOLIAR BOOST 20-20-20+TE','category':'other','img':'/static/images/product_foliarboost.jpg','stock':95,'reorder':15,
  ...
  'description':'Premium water-soluble foliar fertilizer with balanced NPK plus essential trace elements for rapid correction of deficiencies.'},
 {'name':'KNAPSACK SPRAYER 16L','category':'other','img':'/static/images/product_sprayer.jpg','stock':35,'reorder':5,
  ...
  'packing':'Per unit',
  'description':'Heavy-duty manual knapsack sprayer with 16-litre tank, anti-drip nozzle and padded shoulder straps.'},
]
